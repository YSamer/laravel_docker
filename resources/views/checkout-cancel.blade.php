<x-layouts.app :title="__('Checkout Cancel')">
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 py-16 px-8 flex flex-col items-center justify-between gap-4 my-8">
        <h2 class="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
            <span class="block">{{ __('Checkout canceled') }}</span>
        </h2>
    ...
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 py-16 px-8 flex flex-col items-center justify-between gap-4 my-8">
        <div class="w-full">
            <p class="leading-relaxed text-lg text-gray-500">
                {{ __('You have canceled your purchase. If you have any questions or concerns about your purchase, please don\'t hesitate to reach out to us at') }} <a class="text-blue-600 underline" href="mailto:{{ config('mail.from.address') }}">{{ config('mail.from.address') }}</a>.
            </p>
        </div>
    </div>
</x-layouts.app>